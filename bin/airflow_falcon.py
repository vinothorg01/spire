...
notebook_params = {"Brand_Name": "self", "Mode": "prod"}
...
t2 = SSHOperator(
    ...
    command="/home/akatiyal/datasci-virality/bin/airflow/brand={}/airflow_socialflow.sh ",  # TODO update the brand name
    dag=dag,
)
...
t3 = SSHOperator(
    ...
    command="/home/akatiyal/datasci-virality/bin/airflow/brand={}/airflow_run.sh ",  # TODO update the brand name
    dag=dag,
)
...
t4 = SSHOperator(
    ...
    command="/home/akatiyal/datasci-virality/bin/airflow/brand={}/airflow_logging.sh ",  # TODO update the brand name
    dag=dag,
)
